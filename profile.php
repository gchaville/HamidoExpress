...
echo "<div class=\"panel panel-default\">
        ...
        <div id=\"passenger\" class=\"panel-body collapse\">
            <ul class=\"list-group\">
...
if (isset($_SESSION['driverid'])) {
    ...
    echo "<div class=\"panel panel-default\">
            ...
            <div id=\"driver\" class=\"panel-body collapse\">
                <ul class=\"list-group\">
...
<?php
    if (isset($_SESSION['driverid'])) {
        echo "<button type = \"button\" class=\"btn btn-primary\" onclick = \"location.href='newtravel.php'\" > Nouveau voyage </button >
