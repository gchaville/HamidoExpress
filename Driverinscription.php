...
<section id="content">
    <div class="col-md-4">
        ...
        <div class="form-group">
            <label for="inputFirstName" class="control-label">Pseudo</label>
            <input type="text" class="form-control" id="inputFirstName" name="username" placeholder="Pseudo" required>
        </div>

        <div class="form-group">
            <label for="inputLastName" class="control-label">Année de conduite</label>
            <input type="text" class="form-control" id="drivingYear" name="drivingYear" placeholder="0" required>
        </div>

        <div class="form-group">
            <label for="inputDOB" class="control-label">Nombre de passagers</label>
            <input type="number" class="form-control" id="nbPassenger" name="nbPassenger" placeholder="0" required>
        </div>

        <div class="form-group">
            <label for="inputEmail" class="control-label">Auto fumeur?</label>
            <input type="checkbox" id="Smoking" name="smoking" value=1>
        </div>

        <div class="form-group">
            <label for="inputAddress" class="control-label">Air climatisé?</label>
            <input  type="checkbox" id="airConditioning" name="airConditioning" value=1>
        </div>

        <div class="form-group">
            <label for="inputPhone" class="control-label">Grande valise?</label>
            <input type="checkbox" id="suitcase" name="suitcase" value=1>
        </div>

        <div class="form-group">
            <label for="inputUsername" class="control-label">Animaux</label>
